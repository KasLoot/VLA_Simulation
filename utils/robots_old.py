...
class FrankaPandaRobot_new:
    ...
    def solve_differential_ik(self, model, data, target_pos, target_rot_matrix, q0, ee_site_id):
        ...
        return np.clip(dq + dq_null, -self.MAX_ANGVEL, self.MAX_ANGVEL)